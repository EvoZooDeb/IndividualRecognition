...
for i in range(epochs):
    ...
    if i%2 == 1:    
        ...
        plus_accuracy_crop = sum(val_plus_res_crop == val_plus_classes_crop)/val_plus_data.shape[0]
    ...
    for j in np.random.permutation( range(len(my_data)) ):
        ...
        print("Epoch: " + str(i) + "     "  + "loss: " + str(float(loss)) + "    mean_loss: "
              + str(float(mean_loss)) + "     "  +   "step: " + str(indexing_counter))
            
    model1.save("/home/dkatona/big_test.h5")