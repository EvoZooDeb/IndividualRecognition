...
horse_catalog_pic =[szazxszep_plus_val_crop,thetisz_plus_val_crop,panka_plus_val_crop,huba_plus_val_crop,lilla_plus_val_crop,lantos_plus_val_crop]
...
for i in range(epochs):
    ...
    if i%2 == 1:    
        ...
        print("Catalog accuracy: ", catalog_accuracy)
        print("  Confusion matrix (catalog pictures over catalog prediction)")
        print(confusion_matrix(catalog_result_array, catalog_classes))
        
        if validation_accuracy > max_accuracy:
            max_acc_epoch = i
            max_accuracy  = validation_accuracy
            model1.save('/home/dkatona/inception_test_latest_catalog.h5')
